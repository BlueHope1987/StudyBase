...
"""
Version 2.0
- init XTrain, YTrain, XTest, YTest when read data
- normalize data x to [-1, 1]
"""
...
class MnistImageDataReader_2_0(DataReader_2_0):
    ...
    def __NormalizeData(self, XRawData):
        ...
        X_NEW = (XRawData - x_min)/(x_max-x_min)  # [0, 1]
        X_NEW = (X_NEW - 0.5)/0.5   # [-1, 1]
        return X_NEW
