...
SRC_TRAIN_DATA ='train.txt.up.clean' #'train.in.txt'
TGT_TRAIN_DATA ='train.txt.down.clean' #'train.out.txt'
SRC_DEV_DATA = 'dev.txt.up' #'test.in.txt'
TGT_DEV_DATA = 'dev.txt.down' #'text.out.txt'
MERGE_VOCAB = 'merge.txt.vocab.clean' #'vocab.txt'
VOCAB_SIZE = 9122
